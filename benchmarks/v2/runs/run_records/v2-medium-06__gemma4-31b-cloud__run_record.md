...
- 	ask_id: $(System.Collections.Hashtable.Id)
- 	ask_title: $(System.Collections.Hashtable.Title)
- model_id_used: $modelId
- un_date: YYYY-MM-DD
- 	hinking_mode_used: 
- prompt_version: 	asks/v2-medium-06/prompt.md
- context_files_shared:
- `context/foundation_settlement.py`
- aw_output_path: uns/raw_outputs/v2-medium-06__.md
- ate_limit_or_refusal_notes:
- latency_notes:
- manual_observations:
