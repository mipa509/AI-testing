...
- `glm-5.3-flash` followed on the same route and tasks the same day; see `benchmarks/addendum_2026-09-18_glm-5.3-flash.md`. Both partial models carry provisional v2 averages over Task 2 and the anchor.
