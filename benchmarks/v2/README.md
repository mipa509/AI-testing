...
- `gemma4:26b-local` (2026-09-19 addendum; Ollama local, free; Task 2 only)
...
- `glm-5.3-flash` followed on the same route and tasks the same day; see `benchmarks/addendum_2026-09-18_glm-5.3-flash.md`. `tencent-hy4-preview` followed on the same route and tasks; see `benchmarks/addendum_2026-09-18_tencent-hy4-preview.md`. `claude-fable-5.1-high` (2026-09-19; Claude Fable 5.1 run in Claude Code, identity withheld from the judges until scoring was complete) followed on the same tasks; see `benchmarks/addendum_2026-09-19_claude-fable-5.1-high.md`. `gemma4:26b-local` (2026-09-19, Ollama local, free) ran Task 2 only; see `benchmarks/addendum_2026-09-19_gemma4-26b-local.md`. All five partial models carry provisional v2 averages over the tasks they ran.
