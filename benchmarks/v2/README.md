...
- `glm-5.3-flash` followed on the same route and tasks the same day; see `benchmarks/addendum_2026-09-18_glm-5.3-flash.md`. `tencent-hy4-preview` followed on the same route and tasks; see `benchmarks/addendum_2026-09-18_tencent-hy4-preview.md`. `claude-fable-5.1-high` (2026-09-19; Claude Fable 5.1 run in Claude Code, identity withheld from the judges until scoring was complete) followed on the same tasks; see `benchmarks/addendum_2026-09-19_claude-fable-5.1-high.md`. `gemma4:26b-local` (2026-09-19, Ollama local, free) ran all seven tasks and has a standard six-task average; see `benchmarks/addendum_2026-09-19_gemma4-26b-local.md`. The four partial models carry provisional v2 averages over the tasks they ran.
