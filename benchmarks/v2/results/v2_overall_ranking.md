...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---: |---: |---: |---: |---: |---:|
| Correctness | 4.00 | 3.83 | 4.33 | 4.00 | 3.67 | 3.50 | 2.67 | 4.83 | 4.83 | 3.50 | 4.00 | 4.50 | 4.75 | 3.50 |
| Repo comprehension | 4.00 | 3.83 | 4.50 | 4.17 | 4.00 | 3.50 | 2.83 | 4.67 | 5.00 | 3.50 | 4.00 | 4.50 | 4.75 | 3.67 |
| Change safety | 3.83 | 3.50 | 4.00 | 3.33 | 3.50 | 3.33 | 2.33 | 4.50 | 4.67 | 4.00 | 4.00 | 2.50 | 4.00 | 3.67 |
| Engineering judgement | 4.00 | 3.67 | 4.33 | 3.67 | 3.50 | 3.33 | 2.50 | 4.67 | 4.67 | 3.00 | 4.00 | 3.00 | 3.75 | 3.50 |
| Maintainability | 4.00 | 4.00 | 4.17 | 4.00 | 4.17 | 3.50 | 2.86 | 4.67 | 4.50 | 4.00 | 4.00 | 3.50 | 4.25 | 3.33 |
| Clarity | 4.17 | 4.50 | 4.83 | 4.00 | 4.17 | 4.17 | 3.17 | 4.83 | 4.67 | 3.50 | 4.00 | 3.50 | 4.00 | 3.83 |
| Economics/practicality | 4.67 | 3.83 | 2.83 | 3.00 | 3.00 | 4.33 | 2.17 | 3.00 | 3.00 | 2.50 | 2.50 | 2.50 | 2.50 | 3.00 |
| Overall average | 4.10 | 3.88 | 4.14 | 3.74 | 3.72 | 3.67 | 2.65 | 4.45 | 4.48 | 3.43 | 3.79 | 3.43 | 4.00 | 3.50 |

Provisional columns: `deepseek-v4.1-flash` (Task 2 and the anchor only), `glm-5.3-flash` (Task 2 and the anchor only), `tencent-hy4-preview` (Task 2 and the anchor only), `claude-fable-5.1-high` (Task 2 and the anchor only) were run on a subset of the v2 tasks (2026-09-18 and 2026-09-19 addenda), so their averages cover only those tasks, include the anchor where it was run, and are provisional until the remaining primary tasks are run; they are not comparable with the six-task composite of the other columns.
...
Gemma 4 26B local addendum (2026-09-19): `gemma4:26b-local` ran all six primary tasks and the anchor, so its column is the standard six-task composite (3.50); scored blind with the September offsets after its eight-pack calibration failed the gate (see `benchmarks/addendum_2026-09-19_gemma4-26b-local.md`).
