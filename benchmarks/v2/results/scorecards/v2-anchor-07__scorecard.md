...
- Practicality `anon-2026-09-19` = 2: 6 min 17 s API time, 9 min 32 s wall clock and $1.48; the September floor for slow but usable premium runs on the anchor, as for every other premium and addendum model.
